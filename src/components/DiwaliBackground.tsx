...
const FIREWORKS_SOUND = new URL("../assets/fireworks.mp3", import.meta.url)
  .href;
    ...
    function explode(rocket: Rocket) {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const s: Spark = {
          ...
          color: `hsl(${rocket.hue + (Math.random() - 0.5) * 30} ${
            75 + Math.random() * 20
          }% ${45 + Math.random() * 20}%)`,
  ...
  return (
    <div className="diwali-bg">
      ...
      <div className="diya-player">
        ...
        />
        <div
          style={{ textAlign: "center", padding: "12px 0", color: "#ffd7c2" }}
        >
